 ...
 *
 */
public class EposEvent implements Map<String, Object> {
	 ...
	 *
	 */
	public EposEvent(long startTime, long endTime) {
	 ...
	 */
	public EposEvent(EposEvent duplicate) {
	...
	public String toString() {
		...
		for (String key : this.map.keySet()) {
			if (!key.equals(EposEvent.THIS_KEY) && !key.equals(EposEvent.ORIGNIAL_MESSAGE_KEY)) {
	...
	private String writeMapContent(Map<String, Object> m, String indention) {
		...
		for (String s : m.keySet()) {
			if (s.equals(EposEvent.THIS_KEY)) {
