...
import org.n52.epos.pattern.eml.EMLHelper;
...
import org.n52.ses.pattern.eml.pattern.Statement;
...
public class EsperController implements ILogicController {
	...
	private static final String	CUSTOM_ESPER_FUNCTIONS_NAMESPACE= "org.n52.ses.pattern.eml.filterlogic.esper.customFunctions.*";
...
//	}
	 ...
	 */
	@Override
	public void initialize(EML eml) throws Exception{
			...
			if (pat instanceof PatternSimple) {
				...
				for (PropRestriction propRes : pats.getPropertyRestrictions()) {
					if (propRes.getName().equals(propertyName)) {
						if (propRes.getValue().equals("\"" + MapEposEvent.DOUBLE_VALUE_KEY + "\"")) {
							return Number.class;
						}
					}
				}
