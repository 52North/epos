...
import org.n52.ses.pattern.eml.filter.expression.ABinaryFilterExpression;
...
public abstract class ABinaryComparisonFilter extends AComparisonFilter {
	...
	private boolean checkField(String usedField) {
		 ...
		 * - value
		 */
		if (usedField.equals(MapEposEvent.THIS_KEY) ||
				usedField.equals(MapEposEvent.START_KEY) ||
				usedField.equals(MapEposEvent.END_KEY) ||
				usedField.equals(MapEposEvent.CAUSALITY_KEY) ||
				usedField.equals(MapEposEvent.VALUE_KEY)) {
